...
public class BinaryTreeDriver {
  ...
  public static void main(String args[]) {
    ...
    System.out.println("bst.add(100) : " + bst.add(100));
    System.out.println("bst.add(125) : " + bst.add(125));
    System.out.println("bst.add(117) : " + bst.add(117));
    ...
    System.out.println("bst.contains( 9) : " + bst.contains(9)); 
    System.out.println("bst.contains(19) : " + bst.contains(19));                   
