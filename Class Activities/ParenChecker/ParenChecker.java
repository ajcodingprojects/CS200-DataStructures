...
public class ParenChecker {
  ...
  public static boolean isBalanced(String expression) {
    ...
    int index = 0;
    /*
     * COMPLETE ME: loop over the characters of the string and do the following depending on the character encountered
     ...
     2- for a "closing" paranthesis: 
       ...
       - otherwise, we have a "closing" paranthesis without a corresponding "opening" one so expression isn't 
     balanced
     3- after loop finishes, value of balanced is returned unless stack is not empty .... what does that mean? think 
     about
     */
    ...
    while (index < expression.length()) {
      ...
      if (isOpen(c)) { 
        ...
        if(!s.empty() && OPEN.indexOf(s.peek()) == CLOSE.indexOf(c)) {
          s.pop();
        } else {
          return false;
        }
    ...
    return true; //Update this line as well  ******************************************************************************************
  }
