...
public class NQueens extends JFrame {
  ...
  /**
   * Int variable to keep track of the total number of queens placed to arrive at the solution
   */
  ...
  public NQueens() {
    ...
    queenLocations = new int[boardSize];
    GUIBoard = new TwoDimGrid(boardSize, boardSize);
   ...
   *         false otherwise
   */
  private boolean isUnderAttack(int row, int col){    placementCounter++;
  ...
  public static void main(String [] args) {
    ...
    q.placeQueens(0);
    System.out.println("Total Queens placed: "+placementCounter);
  }
}     
