...
public class CityNamesStreamDriver {
   ...
   * 
   * Step 1. (Using a Scanner object. THIS FIRST PART IS COMPLETE
   ...
   * 
   * Step 2. Get the name of an object file from the user, and call
   ...
   *    parameters.
   *
   * Step 3. Call method objectFile2Output on the same CityNameStreams instance 
  ...
  public void run() {
    ...
    System.out.print("Enter the name of the object file to write to: ");
