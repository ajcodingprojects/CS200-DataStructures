...
public class BookDescription {
   ...
   */
  public BookDescription(String author, String title, String publisher, int date, char rating, int pages, String description) {
    this.author = author;
    this.title = title;
   ...
   * @param title the title of the book
   */
  public BookDescription(String author, String title) {
    this.author = author;
    this.title = title;
    this.publisher = null;
    this.date = -1;
