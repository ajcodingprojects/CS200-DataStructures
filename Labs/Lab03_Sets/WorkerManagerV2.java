 ...
 *
 * @author J. Miller, J. A. Holey, Andrew Nerud and Grant Peroutka
 * @version 9/22/22
 */
public class WorkerManagerV2{
  
  /**
   * The set of workers to keep track of
   */
  private AJNSet<Worker> workers;
  ...
  public WorkerManagerV2(){
    ...
    workers = new AJNArraySet<Worker>();
  }
  ...
  private void load() {
    ...
    try {
      ...
      workers = (AJNSet<Worker>)ois.readObject();
      ois.close();
    } catch (IOException e) {
  ...
  public static void main (String args[]) {
    WorkerManagerV2 manager = new WorkerManagerV2();
    manager.runManager();
  }
}
